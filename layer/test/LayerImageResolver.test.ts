...
describe('LayerImageResolver', () => {
  describe('resolveAsset', () => {
    ...
    it('should throw error for missing registry key', () => {
      ...
      expect(() => resolveAsset(ref, registry)).toThrow('registry key "missing-key" not found');
    });
    ...
    it('should throw error for unknown asset ref type', () => {
      ...
      expect(() => resolveAsset(invalidRef, registry)).toThrow('unknown asset ref type: unknown');
    });
