...
import { mapImageIntoContainer, ContainerSpec } from './LayerMappingImage';
...
describe('LayerMappingImage', () => {
  describe('mapImageIntoContainer', () => {
    ...
    it('should use asset anchor when available', () => {
      ...
      const result = mapImageIntoContainer(assetWithAnchor, undefined, mockAnchor);
    ...
    it('should handle all alignment positions correctly', () => {
      ...
      alignments.forEach(([alignment, expectedOffset]) => {
        ...
        const result = mapImageIntoContainer(mockAsset, testContainer, mockAnchor);
    ...
    it('should handle negative asset dimensions gracefully', () => {
      ...
      const result = mapImageIntoContainer(negativeAsset, container, mockAnchor);
    ...
    it('should handle perfect square asset and container', () => {
      ...
      const result = mapImageIntoContainer(squareAsset, squareContainer, mockAnchor);
